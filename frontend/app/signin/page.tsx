...
const SignInPage: React.FC = () => {
  ...
  useEffect(() => {
    const token = typeof window !== "undefined" ? new URLSearchParams(window.location.search).get("accessToken") : null;
    if (!token) return;
      ...
      <div className="w-full max-w-[550px]">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="space-y-3 mb-6">
            <button
              onClick={() => (window.location.href = getOauthUrl("/auth/google"))}
            ...
            <button
              onClick={() => (window.location.href = getOauthUrl("/auth/linkedin"))}
              className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="text-sm font-medium text-[#6366F1] hover:text-[#5558E3]"
              >
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#6366F1] text-white font-semibold rounded-xl hover:bg-[#5558E3] focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
